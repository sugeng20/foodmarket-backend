        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                <div class="mb-5" role="alert">
                    <div class="bg-red-500 text-white font-bold rounded-y px-4 py-2">
                ...
                <form action="{{ route('food.store') }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input value="{{ old('description') }}" name="description"
                                class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" placeholder="Food description">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <p class="text-gray-600 text-xs italic">
                                Dipisahkan dengan koma, contoh: recomended, popular, new_food
                            </p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
